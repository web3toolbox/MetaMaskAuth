...
const ConnectionWalkThroughModal = ({
  open,
  setWalkThroughModalOpen,
  connected,
}) => {
    ...
    <div className={`modal ${active} connection-walk-through`}>
      ...
      <StyledModalCard className="modal-card">
        ...
        <StyledSection className="modal-card-body">
          <span>
            Complete the two-step sign in process by approving the following
          ...
          >
            ...
            <p style={{ textAlign: "left", marginLeft: "10px" }}>
              ...
              <br />
              Connect your Metamask accounts to use with this site.
            </p>
          </div>
          <div
          ...
          >
            {!connected ? (
              <Circle style={{ color: "grey", border: "1px solid grey" }}>
                2
              </Circle>
            ) : (
              <Circle>2</Circle>
            ...
            <p style={{ textAlign: "left", marginLeft: "10px" }}>
              ...
              <br />
              Sign-in by signing the request.
            </p>
          </div>
        </StyledSection>
      </StyledModalCard>
